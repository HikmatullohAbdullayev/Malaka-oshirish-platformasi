...
function Header() {
  ...
  return (
    <header className=" py-[35px] relative z-10 shadow-lg">
      <div className="container  max-w-[1540px] mx-auto px-[20px] flex gap-2 items-center">
        <div className="inline-block">
          <p
            onClick={changeMenu}
            className="flex items-center gap-[20px] cursor-pointer font-normal text-[20px] text-[#0085FF]"
          >
            <span>
              <MenuIcon />
            </span>
