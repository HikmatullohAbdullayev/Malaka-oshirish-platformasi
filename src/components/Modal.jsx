...
function Modal({toggleModal }) {
    return (
        <div className=' '>
            ...
            <div className="absolute top-[50%]  left-[50%] px-[50px] mt-[20px] max-w-[850px] w-full translate-x-[-50%] translate-y-[-50%]  ">
              <div className="modal-content relative">
                <button className="absolute top-[2%]  right-[2%]" onClick={toggleModal}><CloseIcon/></button>
      ...
      <div className="mb-4">
        <Label htmlFor="date" className="block text-gray-700 w-full text-[18px] ">Muddat</Label>
        <Input type="date" id="date" className="mt-[10px] w-full border border-black" />
      </div>
      <div className="mb-4">
        <label className="block text-gray-700 font-semibold   text-[18px] ">Guruh</label>
        <select className=" w-full border border-black mt-[10px]">
          <option value="" defaultValue="Guruh tanlang" >Guruh tanlang</option>
          <option value="group1">Guruh 1</option>
          <option value="group2">Guruh 2</option>
        </select>
      </div>
      <div className="mb-4">
        <h3 className=' font-semibold  text-[18px] '>Topshiriqni yuklash</h3>
      ...
      <div className="mb-4">
        <label className="block text-gray-700 font-semibold  text-[18px] ">Izoh</label>
