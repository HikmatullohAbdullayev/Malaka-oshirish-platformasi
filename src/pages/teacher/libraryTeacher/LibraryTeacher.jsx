  ...
  return (
    <section className="map">
      <div className="container max-w-[1440px] mx-auto px-[20px] pt-[70px] ">
        ...
        <div className="bg-white w-full  mt-[50px] border pt-[50px] px-[50px] pb-[150px] ">
          ...
          <div className="grid grid-cols-[repeat(auto-fill,minmax(250px,1fr))] gap-[40px] ">
            {library_data.map((item) => (
              ...
              >
                ...
                <h3 className=" text-[#8D8484] font-normal text-[24px] b table900:text-[20px] text-nowrap">
                  {item.title}
                </h3>
                <Link
                  to={item.link}
                  className=" font-normal text-white text-[24px]  table900:text-[20px] bg-blue-500 px-[20px] py-[5px] rounded-lg "
                >
                  Kitoblar
                </Link>
              </div>
