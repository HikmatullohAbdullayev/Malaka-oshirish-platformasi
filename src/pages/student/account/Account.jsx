    ...
    <section className="map">
      <div className="container max-w-[1440px] mx-auto  px-[20px] pt-[70px]">
        ...
        <div className="flex  items-start pt-[50px]  gap-[100px] table1170:gap-[20px] mobile768:flex-col">
          ...
          <div className="border flex items-start justify-start gap-[150px] bg-white py-[18px] px-[24px] table1170:gap-[50px]">
            <div className="">
              <p className="px-[18px] py-[15px] text-[#8D8484] font-normal text-[24px]  table900:text-[20px]">
                FIO
              </p>
