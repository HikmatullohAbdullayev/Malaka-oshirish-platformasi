       ...
       <p>Dars jadvali</p>
        ...
        {lesson.map((item) => (
          <TableRow key={item.id}>
            ...
            <TableCell className={`border ${item.Ju ? "bg-red-300" : "bg-white"}`}>{item.Ju}</TableCell>
            <TableCell className={`border ${item.Shan ? "bg-purple-300" : "bg-white"}`}>{item.Shan}</TableCell>
          </TableRow>
        ))}
      </TableBody>
        </Table>
