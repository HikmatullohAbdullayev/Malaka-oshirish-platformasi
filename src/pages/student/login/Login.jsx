...
const Login = () => {
  return <section className="   bg-blue-500 ">
    ...
    <Link to="/download-login" className=" flex items-center gap-[10px] max-w-[280px] ml-auto py-[5px] px-[16px] bg-white font-normal text-[18px] rounded-[50px] "><span  className="cursor-pointer"><DownloadIcon/></span>Sertifikatni yukalab olish</Link>
