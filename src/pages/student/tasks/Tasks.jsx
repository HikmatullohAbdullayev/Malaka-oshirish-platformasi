          ...
          <Table className="min-w-full  border  border-gray-200">
            <TableHeader>
              <TableRow className="">
                ...
                <TableHead className="px-[14px]  text-[#8D8484] text-start w-[80px] py-[15px] font-normal text-[24px]   table900:text-[22px] mobile530:w-[40%] desktop:px-[2px] ">
                  Vazifa
                </TableHead>
                <TableHead className="px-[18px]  text-[#8D8484] text-start w-[210px] py-[15px] font-normal text-[20px]   table900:text-[22px] mobile530:w-[40%]">
                  Topshirish muddati
                </TableHead>
                <TableHead className="px-[18px]  text-[#8D8484] text-start w-[170px] py-[15px] font-normal text-[24px]   table900:text-[22px] mobile530:w-[40%]">
                  Fayl
                </TableHead>
                <TableHead className="px-[18px]  text-[#8D8484] text-start w-[450px] py-[15px] font-normal text-[24px]   table900:text-[22px] mobile530:w-[40%]">
                  Izoh
            ...
            <TableBody>
              {task_data.map((item) => (
                <TableRow key={item.id} className="border  border-gray-200">
                  ...
                  <TableCell
                    className={`   ${item.status === 'todo' ? ' ' : item.status === 'done' ? 'bg-[#C9EDFF] ' : 'bg-red-500 text-white'}   flex items-center border  max-w-[200px]  my-[15px] rounded-lg py-[5px] font-normal  text-[16px]   table900:text-[14px]`}
                  >
                    <span
                      className={` ${item.status === 'late' ? 'hidden ' : ''}`}
                    >
                      <DownloadIcon />
                    </span>{' '}
