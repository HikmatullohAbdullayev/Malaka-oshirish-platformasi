      ...
      <div>
        <ul className={`${open ? 'block' : 'hidden'} flex flex-col gap-1`}>
          ...
          <Link to="admin/kutubxona-admin">
            <li className="p-1 hover:bg-gray-700 text-white">Kutubxona</li>
          </Link>
          <Link to="admin/Talabalar">
            <li className="p-1 hover:bg-gray-700 text-white">Talabalar</li>
          </Link>
          ...
          <Link to="admin/Fan-yaratish">
            <li className="p-1 hover:bg-gray-700 text-white">+ Fan yaratish</li>
          </Link>
        ...
        <ul>
          <Link to="admin/lesson">
            <li className="p-1 hover:bg-gray-700 text-white">Dars</li>
          </Link>
          <Link to="admin/kutubxona-admin">
            <li className="p-1 hover:bg-gray-700 text-white">Kutubxona</li>
          </Link>
